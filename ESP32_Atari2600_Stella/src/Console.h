...
class Console : public Serializable
{
  ...
  private:
    ...
    static const uInt32 ourSECAMPalette[256];
    ...
    static const uInt32 ourSECAMPaletteZ26[256];

    // Table of RGB values for NTSC, PAL and SECAM - user-defined
    static const uInt32 ourUserNTSCPalette[256];
    static const uInt32 ourUserPALPalette[256];
    static const uInt32 ourUserSECAMPalette[256];
};
