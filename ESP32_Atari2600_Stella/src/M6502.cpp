...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
IRAM_ATTR/*inline*/ uInt8 M6502::peek(uInt16 address, uInt8 flags)
{
  ////////////////////////////////////////////////
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/*IRAM_ATTR*/ /*inline*/ void M6502::poke(uInt16 address, uInt8 value)
{
  ////////////////////////////////////////////////
  // TODO - move this logic directly into CartAR
  if(address != myLastAddress)
...
//      debugStream << "Cyc=" << dec << mySystem->cycles();
      ...
      switch(IR)
      {
        ...
        #include "C:/Users/giltal/Google Drive/ArduinoProjects/ESP32_Atari2600_Stella/ESP32_Atari2600_Stella/src/M6502.ins"
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/*IRAM_ATTR*/ void M6502::interruptHandler()
{
